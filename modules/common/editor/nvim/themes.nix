...
in
{
  programs.nvf.settings.vim = {
    ...
    extraPlugins = {
      "vimplugin-rusticated".package = pkgs.vimUtils.buildVimPlugin {
        name = "rusticated";
      ...
      "vimplugin-rasmus.nvim".package = pkgs.vimUtils.buildVimPlugin {
        name = "rasmus.nvim";
        src  = pkgs.fetchFromGitHub {
          owner  = "kvrohit";
          repo   = "rasmus.nvim";
      ...
      "vimplugin-zenbones.nvim".package = pkgs.vimPlugins.zenbones-nvim;

      # for zenbones
      "vimplugin-lush.nvim".package = pkgs.vimPlugins.lush-nvim;
