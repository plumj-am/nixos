...
in mkIf config.isDesktop {
  home-manager.sharedModules = [
    (homeArgs: let
      system24Theme = if config.isLinux then
				"${homeArgs.config.home.homeDirectory}/.config/vesktop/themes/system24.css"
			else
				"${config.users.users.${config.system.primaryUser}.home}/.config/vesktop/themes/system24.css";
      in {
        programs.vesktop = enabled {
          settings = {
            discordBranch = "ptb";
            tray = true;
          ...
          vencord = {
            ...
            settings = {
              ...
              enabledThemes = [ "system24" ];
            };
            # themes.system24 = system24Theme;
          };
        };

        home.file.".config/vesktop/themes/system24.theme.css".text = /* css */ ''
        /**
         * @name system24
