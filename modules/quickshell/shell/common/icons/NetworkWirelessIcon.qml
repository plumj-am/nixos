...
Item {
    ...
    Shape {
        ...
        ShapePath {
            fillColor: root.bars >= 1 ? root.color : Theme.alpha(root.color, 0.25)
        ...
        ShapePath {
            fillColor: root.bars >= 2 ? root.color : Theme.alpha(root.color, 0.25)
            strokeColor: "transparent"
            PathSvg {
        ...
        ShapePath {
            fillColor: root.bars >= 3 ? root.color : Theme.alpha(root.color, 0.25)
            strokeColor: "transparent"
            PathSvg {
