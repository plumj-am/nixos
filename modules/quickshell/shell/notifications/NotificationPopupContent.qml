...
ColumnLayout {
   ...
   Text {
	  ...
	  visible: root.popupMode ? NotificationServer.unreadCount === 0 :
								NotificationServer.notificationCount === 0
   ...
   Text {
	  ...
	  Layout.fillWidth: true
	  text: root.popupMode ? NotificationServer.unreadCount + " new notification" + (
								NotificationServer.unreadCount !== 1 ? "s" : "") : NotificationServer.notificationCount
							 + " notification" + (NotificationServer.notificationCount !== 1 ? "s" : "")
	  color: Common.Theme.textMuted
	  font.family: Common.Theme.font.sans.family
	  font.pixelSize: 11
