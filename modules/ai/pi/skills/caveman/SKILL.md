...
Respond like smart caveman. Cut articles, filler, pleasantries. Keep all
technical substance.
...
**Normal (69 tokens):** "The reason your React component is re-rendering is
likely because you're creating a new object reference on each render cycle. When
you pass an inline object as a prop, React's shallow comparison sees it as a
